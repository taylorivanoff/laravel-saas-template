...
Route::group(['namespace' => 'Auth\Controllers'], function () {
    ...
    // Registration Routes...
    Route::get('signup', 'RegisterController@showRegistrationForm')->name('register');
...
Route::group(['namespace' => 'Home\Controllers'], function () {
    ...
    Route::post('/', 'HomeController@signup')->name('home.signup');
});
...
Route::group([
    ...
    Route::group(['prefix' => '/subscription', 'namespace' => 'Subscription',
        ...
        Route::group(['prefix' => '/', 'middleware' => ['subscription.customer'], 'as' => 'overview.'], function () {
            // cancel subscription index
            Route::get('/', 'SubscriptionOverviewController@index')->name('index');
        });
